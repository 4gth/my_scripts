...
parser.add_argument(
    "-l", help="Set length of generated passwords", type=int
)  # sets option for length of password
parser.add_argument(
    "-g", help="Set number of generated passwords", type=int
)  # sets option for how many passwords to generate
parser.add_argument(
    "-s", help="Set use of symbols in generated passwords", action="store_true"
)  # if used will generate passwords with symbols in .punctuation
parser.add_argument(
    "-n", help="Set use of numbers in generated passwords", action="store_true"
)  # if used will generate passwords with numbers 0-9
...
passwords = "\n".join(
    GeneratePassword(passwordLength, includeSymbols, includeNumbers)
